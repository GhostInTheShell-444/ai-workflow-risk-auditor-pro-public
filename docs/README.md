...
User and evaluator documentation for AI Workflow Risk Auditor Pro:
...
## Interface and optional local AI

- [Visual Design System](VISUAL_DESIGN_SYSTEM.md)
- [Accessibility and Visual Notes](ACCESSIBILITY_VISUAL_NOTES.md)
- [Dashboard Components](DASHBOARD_COMPONENTS.md)
- [Localization Completeness](I18N_COMPLETENESS.md)
- [Local AI / Ollama](LOCAL_AI_OLLAMA_TAB.md)
- [Ollama Diagnostics](OLLAMA_LOCAL_DIAGNOSTICS.md)
